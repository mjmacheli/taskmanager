...
@Component({
  selector: 'app-future-tasks-list',
  templateUrl: './future-tasks-list.component.html',
  styleUrls: ['./future-tasks-list.component.scss']
})
export class FutureTasksListComponent extends TaskList implements OnInit {
  taskList$ = null;
  ...
  ngOnInit() {
    ...
    this.service.getFutureTasksListModel().subscribe(modelMap => {
